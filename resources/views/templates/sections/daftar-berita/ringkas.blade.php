        ...
        x-data="{
            ...
            async loadMore() {
                ...
                try {
                    ...
                    url.searchParams.set('variant', 'ringkas');
...
>
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 md:gap-x-8" @if ($hasMore) x-ref="list" @endif>
            @include('templates.sections.daftar-berita._items-ringkas', ['items' => $items, 'startIndex' => 0])
        </div>
