    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            @foreach ($items as $item)
                ...
                <div class="reveal group bg-white rounded-2xl p-6 shadow-soft transition-all duration-300 hover:-translate-y-1.5 hover:shadow-float"
                     style="transition-delay: {{ $loop->index * 100 }}ms">
                    <div class="w-11 h-11 rounded-lg bg-secondary/10 text-secondary flex items-center justify-center font-bold mb-4 text-lg transition-transform duration-300 group-hover:scale-110">
