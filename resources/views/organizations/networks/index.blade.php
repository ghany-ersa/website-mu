...
@section('content')
    ...
    <div class="flex items-center justify-between gap-4 mb-8">
        <div>
            <h1 class="text-2xl font-extrabold text-primary">Jaringan AUM/Ortom</h1>
    ...
    <div class="bg-white rounded-2xl shadow-soft divide-y divide-gray-100">
        ...
        @empty
            <p class="p-8 text-center text-sm text-gray-400">Belum ada jaringan AUM/Ortom. Tambahkan yang pertama.</p>
        @endforelse
    </div>
@endsection
