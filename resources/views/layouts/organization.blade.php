...
<body class="bg-softBg text-gray-800 min-h-screen lg:flex">
    ...
    @php
        ...
        $orgMenu = [
            ...
            [
                'route' => 'organizations.officers.index',
            ...
            [
                'url' => route('organizations.programs.index', $organization).'?type=program',
            ...
            [
                'url' => route('organizations.programs.index', $organization).'?type=layanan',
                'pattern' => request()->routeIs('organizations.programs.*') && request('type') === 'layanan',
                'label' => 'Layanan',
