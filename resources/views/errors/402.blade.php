...
@section('actions')
    <a href="{{ url('/#harga-paket') }}" class="bg-white hover:bg-gray-50 text-gray-800 border border-gray-200 px-6 py-3.5 rounded-full text-sm font-bold shadow-soft transition-all">
        Lihat Paket
    </a>
@endsection
